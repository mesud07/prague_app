...
class OtherFaqPage extends StatefulWidget {
  @override
  _OtherFaqPageState createState() => _OtherFaqPageState();
}
class _OtherFaqPageState extends State<OtherFaqPage> {
  @override
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Row(
          ...
          children: [
            Container(width: 40),
            Text("Other",style: GoogleFonts.ubuntu(color: Colors.black),)
          ]),),
      body: Container(
        color: Colors.white,
        padding: EdgeInsets.all(20),
        child: FutureBuilder(
            future: otherLoadData(),
